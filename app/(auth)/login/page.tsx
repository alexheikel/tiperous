  ...
  return (
    <div style={{ minHeight:'100dvh', background:'#0c0c0e', display:'flex', alignItems:'center', justifyContent:'center', padding:20 }}>
      <div style={{ width:'100%', maxWidth:380 }}>
        <Link href="/landing" style={{ display:'inline-flex', alignItems:'center', gap:6, color:'rgba(255,255,255,0.4)', textDecoration:'none', fontSize:14, marginBottom:32, fontWeight:500 }}>
          ← Volver
        </Link>
