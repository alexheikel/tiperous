...
//  GET  /api/tips?company_id=xxx&limit=20
//  POST /api/tips  { company_id, type, segment, text }
// ============================================================
...
export async function POST(req: NextRequest) {
  ...
  if (error) {
    // Unique constraint = duplicate tip
    if (error.code === '23505') {
      return NextResponse.json({ error: 'Ya dejaste un tip similar hoy en esta empresa.' }, { status: 409 })
    }
