...
export default function TipCard({ tip, delay=0 }: { tip:Tip; delay?:number }) {
  ...
  return (
    <div className="animate-fade-up" style={{
        ...
        <div style={{ display:'flex', alignItems:'center', gap:6 }}>
          ...
          {!reported && (
            <button onClick={()=>setShowReport(!showReport)} title="Denunciar" style={{
              ...
              color:'var(--muted)', padding:'2px', borderRadius:4,
          ...
          {reported && <span style={{ fontSize:10, color:'var(--muted)', fontStyle:'italic' }}>Denunciado</span>}
        </div>
      </div>
      ...
      {showReport && (
        <div style={{
          background:'var(--card2)', borderRadius:12, padding:'10px',
