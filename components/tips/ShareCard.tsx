  ...
  return (
    <div style={{
      ...
      <div onClick={e=>e.stopPropagation()} style={{ width:'100%', maxWidth:400 }}>
        ...
        {/* Copy text */}
        <div style={{
          background:'rgba(255,255,255,0.05)', borderRadius:12, padding:'12px 14px', marginBottom:14,
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
          <button onClick={shareTwitter} style={{
            ...
            background:'#000', color:'#fff', fontFamily:'inherit', fontWeight:700, fontSize:14,
